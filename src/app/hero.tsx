        ...
        <div className="mt-40 grid gap-6 lg:mt-0">
          <div className="grid grid-cols-4 gap-6">
            <Image
              width={768}
              height={768}
              src="/image/books/gfvb.jpg"
              className="rounded-lg shadow-md h-52 object-cover"
              alt="flowers"
            />
            <Image
              width={768}
              height={768}
              src="/image/books/po.webp"
              className="-mt-28 rounded-lg shadow-md h-52 object-cover"
              alt="flowers"
            />
            <Image
              width={768}
              height={768}
              src="/image/books/ppp.jpeg"
              className="-mt-14 rounded-lg shadow-md h-52 object-cover"
              alt="flowers"
            />
            <Image
              width={768}
              height={768}
              src="/image/books/tp.webp"
              className="-mt-20 rounded-lg shadow-md h-52 object-cover"
              alt="flowers"
            />
          </div>
          <div className="grid grid-cols-4 gap-6">
